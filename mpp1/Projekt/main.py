...
def knn_algorithm(train_data,test_instance,k):
    ...
    most_common_value = sorted_most_common[0]
...
def main():
    ...
    for test_instance in test_data:
        ...
        print("for k value =",k,"expected value was:",expected_value.upper(),",real value is",real_value.upper(),'\n')
    print("number of positive tests =",positive_test)
    print("test correctness = ",round(positive_test/all_tests,3))
    while True:
        try :
            attributes_input = input("Enter attributes separated by white space (e.g., 5.1 3.5 1.4 0.2): ")
